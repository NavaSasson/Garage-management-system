...
namespace Ex03.GarageLogic
{
    ...
    {
        private const float MaxFuelTankInLiter = 58;
        ...
        public FuelCar(string i_LicenseNumber)
            : base(i_LicenseNumber, eFuelType.Octan95, MaxFuelTankInLiter, CarInfo.NumOfWheelsInCar, CarInfo.MaxAirPressureInCar)
        {
            CarInfo = new CarInfo();
        }
        ...
        {
            string fuelCarDetails = base.ToString() + CarInfo.ToString();

            return fuelCarDetails;
        }
    }
}